    ...
    public static void mostrarAlunos() {
        if (nomeAlunos[0] == null) {
            ...
            if(nomeAlunos[i]!=null){
                cont=cont+1;
                System.out.println("000" + cont  + "\t" + nomeAlunos[i]);}
        ...
        if(tela > 0 ){
          ...
          System.out.print("\n");
            ...
            for(String aluno : nomeAlunos){
              ...
              System.out.println("000" + cont++ + "\t" + aluno);
               
              if( naluno >= tela){
                  interC.showMsg("Proxima pagina--Prima Enter");
                  System.out.println("...........................................\n ");
                  naluno=0;
 ...
 /**
    ...
    private static void calcularMaxMinAvg() {
        ...
        if(nomeAlunos[0]==null){
            ...
            notaAvg=soma/cont;
            System.out.println("Media das notas é :" + notaAvg);
    ...
    public static void mostraResumo() {
        ...
        int NotasS = 0;
        int NotaI = 0;
        int Notaigualmedia=0;
        

        for(int i=0;notasAlunos[i]!=0;i=i+1){
           if(notasAlunos[i] > notaAvg){
                 ...
                 if(notasAlunos[i] < notaAvg){
                  NotaI=NotaI+1; }
                    ...
                    if(notasAlunos[i] == notaAvg){
                    Notaigualmedia = Notaigualmedia+1;}
                  }
              
    }}


    System.out.println("Alunos com notas inferiores a media:" + NotaI);
    System.out.println("Alunos com notas superiores a media:" + NotasS);
    System.out.println("Alunos com notas igual a media:" + Notaigualmedia);
    ...
    public static void mostrarTop() {
        interC.showMsg("Não foi emplementado");}
    ...
    if(nomeAlunos!=null){
          ...
          System.out.print("\n");
            ...
            if( nomeAlunos[i]== null)
              ...
              System.out.println("000" + cont++ + "\t" + nomeAlunos[i] + "--" + notasAlunos[i]);
               
              if( naluno >=10){
                //interC.showMsg("Proximos Alunos--Prima Enter");
                  System.out.println("...........................................\n ");
                  naluno=0;
        ...
        if (nomeAlunos[0] == null) {
            ...
            for (int i=0;i<= nomeAlunos.length-1;i++){
                ...
                if(nota == notasAlunos[i] && nomeAlunos[i] != null){
                    System.out.println("000"+ cont + "\t  " + nomeAlunos[i] + "\t Nota:" + notasAlunos[i]);}
